...
export function hangman(count, text) {
    ...
    if (count < 6) {
        ...
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(50, 145, 15, -2 / 3 * Math.PI, -1 / 3 * Math.PI, false);
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(44, 114, 2, 0, Math.PI * 2, true);
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(56, 114, 2, 0, Math.PI * 2, true);
        ctx.stroke();
    }
