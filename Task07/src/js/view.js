...
export function hangman(count, text) {
    ...
    if (count < 6) {
        ctx.beginPath();
        ctx.arc(175, 120, 20, 0, Math.PI * 2, true);
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(175, 145, 15, -2 / 3 * Math.PI, -1 / 3 * Math.PI, false);
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(169, 114, 2, 0, Math.PI * 2, true);
        ctx.stroke();
        ctx.beginPath();
        ctx.arc(181, 114, 2, 0, Math.PI * 2, true);
        ctx.stroke();
    }
